...
##### Pha 2: Tune PID Canh giữa bằng Cảm biến tường (Wall PID)
*Đặt robot vào đường thẳng có 2 bên vách.*

1. **Tune $K_{p\_wall}$:** Cho robot chạy thẳng với tốc độ cơ sở ổn định (đã tune ở Pha 2). Lấy tay đẩy nhẹ robot lệch sang sát tường trái. 
...
##### Pha 3: Tune PID Đi thẳng thuần bằng Encoder (Straight PID)
